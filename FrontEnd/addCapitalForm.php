                    ...
                    <div class="art-layout-cell art-content">
                    	<article class="art-post art-article">
                            <div class="art-postmetadataheader">
                                <h1 style="font-size:36px" align="center">ثبت سرمایه</h1>
                            </div>                    
                            	...
                            	<div class="art-content-layout">
    								<div class="art-content-layout-row">
    									<div class="art-layout-cell layout-item-0" style="width: 100%" >
                                        	<div align="center">
											<form action="../PHP/addCapital.php" method="post">
                                            	<table align="center">
                                                	<tr>
                                                    	<th><label for="money">مقدار پول</label></th>
                                                        <td><input type="text" id="money" name="money" size="30" /></td>
                                                    </tr>
                                                    <tr>
...
<script src="../JQuery/addCapitalForm.js"></script>