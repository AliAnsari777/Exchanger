...
<head>
    <meta charset="utf-8">
    <title>Confirm Delete Capital Record</title>
                            	...
                            	<div class="art-content-layout">
    								<div class="art-content-layout-row">
    									<div class="art-layout-cell layout-item-0" style="width: 100%" >
                                        	<div align="center">
												<p style="font-size:24px">آیا میخواهید این واحد پولی را از بخش سرمایه حذف کنید؟</p>
                                                <p style="font-size:20px; font-weight:bolder">
                                                	<span style="text-decoration:blink"><a id="ok" href="../PHP/deleteCapital.php?id=<?php echo $capitalId ?>">بلی</a> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp; &nbsp;<a href="#" id="no">خیر</a></span>
                                                </p>
                                            </div>
    									</div>
    								</div>
