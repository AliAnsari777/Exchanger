                            	...
                            	<div class="art-content-layout">
    								<div class="art-content-layout-row">
    									<div class="art-layout-cell layout-item-0" style="width: 100%" >
                                        	<div align="center">
												<p style="font-size:24px">آیا شما میخواهید <span style="color:rgba(255,0,0,1)"><?php echo $clientName ?> </span>را از لیست معامله داران خود حذف کنید؟</p>
                                                <p style="font-size:20px; font-weight:bolder">
                                                	<span style="text-decoration:blink"><a id="ok" href="../PHP/deleteClient.php?id=<?php echo $clientId ?>">بلی</a> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp; &nbsp;<a href="#" id="no">خیر</a></span>
                                                </p>
                                            </div>
    									</div>
    								</div>
