...
<head>
    <meta charset="utf-8">
    <title>Confirm Delete Transmission</title>
                            	...
                            	<div class="art-content-layout">
    								<div class="art-content-layout-row">
    									<div class="art-layout-cell layout-item-0" style="width: 100%" >
                                        	<div align="center">
												<p style="font-size:24px">آیا شما میخواهید که این حواله را حذف کنید؟</p>
                                                <p style="font-size:20px; font-weight:bolder">
                                                	<span style="text-decoration:blink"><a id="ok" href="../PHP/deleteTransmission.php?id=<?php echo $transmissionId ?>">بلی</a> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp; &nbsp;<a href="#" id="no">خیر</a></span>
                                                </p>
                                            </div>
    									</div>
    								</div>
...
<script>
	...
	$("#ok").on("click", function(e){
		if(confirm("Are you sure you want to delete this Tramsmission?"))
		{
