                    ...
                    <div class="art-layout-cell art-content">
                    	<article class="art-post art-article">
                            <div class="art-postmetadataheader">
                                <h1 style="font-size:36px" align="center">فورم ایجاد تغییر در سرمایه</h1>
                            </div>                    
    									...
    									<div class="art-layout-cell layout-item-0" style="width: 100%" >
                                        	<div align="center">
												<?php
													...
													$editCapital = new Capital();
													$editCapital->EditCapital($Cid);	
												?>
                                            </div>
    									</div>
    								</div>
...
<script src="../JQuery/editCapitalForm.js"></script>