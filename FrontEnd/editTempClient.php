...
<head>
    <meta charset="utf-8">
    <title>View Temporary Client</title>
                    ...
                    <div class="art-layout-cell art-content">
                    	<article class="art-post art-article">
                            <div class="art-postmetadataheader">
                                <h1 style="font-size:36px" align="center">مشخصات <?php echo $clientName ?></h1>
                            </div>                    
    									...
    									<div class="art-layout-cell layout-item-0" style="width: 100%" >
                                        	<div align="center">
												<?php
													...
													$editTempClient = new TemporaryClients();
													$editTempClient->EditTempClient($clientId);
												?>
                                            </div>
    									</div>
    								</div>
