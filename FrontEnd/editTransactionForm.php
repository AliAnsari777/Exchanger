                    ...
                    <div class="art-layout-cell art-content">
                    	<article class="art-post art-article">
                            <div class="art-postmetadataheader">
                                <h1 style="font-size:36px" align="center">فورم ایجاد تغییر در معامله</h1>
                            </div>                    
    									...
    									<div class="art-layout-cell layout-item-0" style="width: 100%" >
                                        	<div align="center">
												<?php
													...
													$editForm = new Transactions();
													$editForm->EditTransactionForm($TransactionId);
												?>
                                            </div>
    									</div>
    								</div>
...
<script src="../JQuery/editTransactionForm.js"></script>