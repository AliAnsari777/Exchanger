                    ...
                    <div class="art-layout-cell art-content">
                    	<article class="art-post art-article">
                            <div class="art-postmetadataheader">
                                <h1 style="font-size:36px" align="center">ثبت حواله جدید</h1>
                            </div>                    
                            	...
                            	<div class="art-content-layout">
    								<div class="art-content-layout-row">
    									<div class="art-layout-cell layout-item-0" style="width: 100%" >
                                        	<div align="center">
											<form action="../PHP/newTransmission.php" method="post">
                                            	<table align="center">
                                                    <tr>
                                                    	<th><label for="sender">فرستنده</label></th>
                                                        <td><input type="text" id="sender" name="sender" size="30" /></td>
                                                    </tr>
                                                    <tr>
                                                    	<th><label for="reciever">گیرنده</label></th>
                                                        <td><input type="text" id="reciever" name="reciever" size="30" /></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td><input type="text" id="transmissionNumber" name="transmissionNumber" size="30" /></td>
                                                    </tr>
                                                    <tr>
                                                    	<th><label for="senderLocation">محل ارسال</label></th>
                                                        <td><input  type="text" id="senderLocation" name="senderLocation" size="30" /></td>
                                                    </tr>
                                                    <tr>
                                                    	<th><label for="recieverLocation">محل دریافت</label></th>
                                                        <td><input type="text" id="recieverLocation" name="recieverLocation" size="30" /></td>
                                                    </tr>
                                                    <tr>
                                                       	<th><label for="passed">تسلیم شد</label></th>
                                                        <td><input  type="checkbox" id="passed" name="passed" value="1" /></td>
                                                        <input hidden="" name="passed" value="0" />
                                                    </tr>
                                                    <tr>
...
<script src="../JQuery/newTransmissionForm.js"></script>