$(document).ready(function(e) {
	...
	$("#submit").on("click", function(e){
		if($("#sender").val() == "" || $("#reciever").val() == "")
		{
			e.preventDefault();
			alert("Please provide a sender and reciever names!");
			$("#sender").css({"border" : "2px inset #07c", "box-shadow" : "0 0 20px red"});
			$("#reciever").css({"border" : "2px inset #07c", "box-shadow" : "0 0 20px red"});	
		}
		else if($("#incoming").val() == "" && $("#outgoing").val() == "")
		{
			e.preventDefault();
			alert("Please provide a value for transmission!");
		...
		else if ($("#transmissionNumber").val() == "")
		{
			e.preventDefault();
			alert("Please enter a transmission number!");
			$("#transmissionNumber").css({"border" : "2px inset #07c", "box-shadow" : "0 0 20px red"});
		}
		else if ($("#senderLocation").val() == "")
		{
			e.preventDefault();
			alert("Please enter a sender location!");
			$("#senderLocation").css({"border" : "2px inset #07c", "box-shadow" : "0 0 20px red"});	
		}
		else if($("#recieverLocation").val() == "")
		{
			e.preventDefault();
			alert("Please enter a reciever location!");
			$("#recieverLocation").css({"border" : "2px inset #07c", "box-shadow" : "0 0 20px red"});		
		}
